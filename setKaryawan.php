...
if (isset($_GET['page'])) {
    ...
    //filter
    isset($_POST['entries']) ? $entries = $_POST['entries'] : $entries = 25;
    ...
    $karyawan = $filterView->fetch_all(MYSQLI_ASSOC);
...
<body>
    ...
    <main>
        ...
        <div class="btn">
            ...
            <div class="search">
                <input type="text" class="search-input" id="search" onkeyup="searchTable()" placeholder="Cari Nama Di Sini...">
