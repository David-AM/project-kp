...
<head>
    ...
    <title>Admin | Edit Pertanyaan</title>
</head>
        ...
        <section class="h-full w-4/5">
            <form method="POST">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <input type="text" name="kategori" class="relative bg-[#D9D9D9] p-4 border-[0.1rem] border-solid rounded-xl w-full" value="<?= $oKategori ?>" placeholder="Masukkan Kategori" style="margin-bottom:2rem" required>
                </div>

                <div class="flex flex-wrap gap-2">
                    <h5 class="relative">Pertanyaan : </h5>
                    <textarea type="text" name="pertanyaan" class="relative bg-[#D9D9D9] p-4 border-[0.1rem] border-solid rounded-xl w-full" value="<?= $oPertanyaan ?>" placeholder="Masukkan Pertanyaan" style="margin-bottom:1rem" required></textarea>
                </div>
                ...
                <div class="my-6">
                    ...
                    <div class="my-2 grid grid-cols-[20% 100%] items-center">
                        ...
                        <input type="text" name="SP" class="relative bg-[#D9D9D9] px-4 py-3 border-[0.1rem] border-solid rounded-xl w-2/12" value="<?= $oSP ?>" placeholder="Masukkan Nilai">
                    </div>
                    <div class="my-2 grid grid-cols-[20% 100%] items-center">
                        <h5 class="relative">Puas :</h5>
                        <input type="text" name="P" class="relative bg-[#D9D9D9] px-4 py-3 border-[0.1rem] border-solid rounded-xl w-2/12" value="<?= $oP ?>" placeholder="Masukkan Nilai">
                    </div>
                    <div class="my-2 grid grid-cols-[20% 100%] items-center">
                        <h5 class="relative">Cukup Puas :</h5>
                        <input type="text" name="CP" class="relative bg-[#D9D9D9] px-4 py-3 border-[0.1rem] border-solid rounded-xl w-2/12" value="<?= $oCP ?>" placeholder="Masukkan Nilai">
                    </div>
                    <div class="my-2 grid grid-cols-[20% 100%] items-center">
                        <h5 class="relative">Kurang Puas :</h5>
                        <input type="text" name="KP" class="relative bg-[#D9D9D9] px-4 py-3 border-[0.1rem] border-solid rounded-xl w-2/12" value="<?= $oKP ?>" placeholder="Masukkan Nilai">
                    </div>
                    <div class="my-2 grid grid-cols-[20% 100%] items-center">
                        <h5 class="relative">Tidak Puas :</h5>
                        <input type="text" name="TP" class="relative bg-[#D9D9D9] px-4 py-3 border-[0.1rem] border-solid rounded-xl w-2/12" value="<?= $oTP ?>" placeholder="Masukkan Nilai">
                    </div>
                </div>
