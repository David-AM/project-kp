...
<body class="box-border bg-white font-inter dark:bg-slate-700">
    ...
    <main class="flex justify-center items-center">
        <section class="h-full w-4/5">
            ...
            <button onclick="window.location.href='addKaryawan.php'" class="w-28 text-center my-2 py-2 rounded-lg relative border-none text-white text-xl font-semibold cursor-pointer bg-[#3E8EEE]">Add</button>
            <table id="example" class="table display h-fit overflow-x-auto table-fixed" style="width: 100%; ">
                <thead class="bg-[#3E8EEE] ">
                    <tr>
                        ...
                        <th class="border text-white text-center" width="11%">NIP</th>
                        <th class="border text-white text-center">Nama</th>
                        <th class="border text-white text-center" width="25%">Divisi</th>
                        <th class="border text-white text-center" width="11%">Jabatan</th>
                        <th class="border text-white text-center" width="11%">Otoritas</th>
                ...
                <tbody>
                    ...
                    while ($karyawan = mysqli_fetch_array($result)) : ?>
                        <tr>
                            ...
                            <td class="border text-center overflow-hidden text-ellipsis whitespace-nowrap"><?= $karyawan['Nip'] ?></td>
                            <td class="border text-center overflow-hidden text-ellipsis whitespace-nowrap"><?= $karyawan['Nama'] ?></td>
                            <td class="border text-center"><?= $karyawan['Divisi'] ?></td>
                            <td class="border text-center overflow-hidden text-ellipsis whitespace-nowrap"><?= $karyawan['Jabatan'] ?></td>
                            <td class="border text-center"><?= $karyawan['Role'] ?></td>
                            <td class="border text-center" height="30px">
                                <a href="addKaryawan.php?page=edit&id=<?= $karyawan['id']; ?>" id="edit" class="py-1 px-2 rounded-md font-semibold bg-sky-600 text-white">Edit</a>
                                <a href="Karyawan.php?page=hapus&id=<?= $karyawan['id']; ?>" id="delete" class="alert_notif py-1 px-2 rounded-md font-semibold bg-red-600 text-white">Delete</a>
