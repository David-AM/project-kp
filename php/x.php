<?php 
    ...
    if(empty($_SESSION['filter']) || isset($_POST['resetFilter'])){
        ...
        $result = mysqli_query($conn, "SELECT * FROM pertanyaan");
        $filterView = mysqli_query($conn, "SELECT * FROM pertanyaan LIMIT $firstIndex, $entries");
...
<body id="top">
        ...
        <div class="btn">
            ...
            <div class="filter">
                <form  method="POST" id="filter">
                    ...
                    <a href="x.php?page=1"><input type="submit" class="reset" name="resetFilter" value="Reset"></a>
                </form>
            </div>
        </div>
        ...
        <div class="table-container">
            <table class="table1" height="100px">
                <tr>
                    <th width="20px">No</th>
                    <th width="150px">
                        <input class="colKategori" type="submit" name="sortir" value="Kategori">
    ...
    //let sort = document.querySelector('#sortir');
        document.querySelector('#sortir').onclick = () => {
            <??>
        }   
    </script>
